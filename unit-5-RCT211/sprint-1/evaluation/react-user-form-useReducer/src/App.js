...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    submittedData.name = state.name;
    submittedData.gender = state.gender;
    submittedData.role = state.role;
    submittedData.maritalStatus = state.maritalStatus;
...
return (
    <div className="App">
      <div>
        ...
        <div className="form-wrapper" data-testid="form-wrapper">
          <form data-testid="form-element" onSubmit={handleSubmit}>
            <div className="name-wrapper" data-testid="name-wrapper">
              ...
              <input name = "name" type="text" placeholder="Name" attribute="name" value={state.name} onChange={(e)  =>dispatch({type:"name" , payload: e.target.value})}/>
            </div>
            ...
            >
              ...
              <div>
                ...
                <input type={"checkbox"} name={state.maritalStatus} onChange={(e) => dispatch({type: "maritalStatus", payload: e.target.checked})} />
                <label>Married</label>
              </div>
            </div>
            <div>
        ...
        {(submittedData).length > 0 ? <div></div> :<h2 data-testid ="no-user-container">no users found</h2>}
      </div>
    </div>
  );
}
